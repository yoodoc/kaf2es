...
public class Kafka2Es {
	...
	private static Map<String, String> parseCmdOptions(String[] args)
		...
		String esBulkMaxIntervalSec = cmd
				.getOptionValue(OPTION_ES_BULK_INTERVAL_SEC);
		...
		if (cmd.hasOption(OPTION_ENABLE_ES_INSERT) && esAddress != null
				&& esClusterName != null) {
	...
	private static Options buildOptions() {
		...
		@SuppressWarnings("static-access")
		Option esClusterName = OptionBuilder
